...
# IterativeImputer_missing_25 IterativeImputer_quantile_25 KNNImputer_missing_25 SimpleImputer_missing_25

directory_in = "..\\SimpleImputer_quantile_75"
...
for csv_file in os.scandir(directory_in):
    ...
    n_params = (n_features + n_classes) * h_layer_size
    
    print(csv_file, n_objects, n_features, n_classes, h_layer_size, n_params)
